...
export class Init1778784326782 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_29f5713899c32a96a8900143c6" ON "marcas" ("nombre") `,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."alfajores_tipo_enum" AS ENUM('CHOCOLATE', 'BLANCO', 'NEGRO', 'FRUTAL', 'MAICENA', 'OTRO')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."alfajores_status_enum" AS ENUM('PENDING', 'APPROVED', 'REJECTED')`,
    );
    await queryRunner.query(
      `CREATE TABLE "alfajores" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "nombre" character varying(150) NOT NULL, "marca_id" uuid NOT NULL, "tipo" "public"."alfajores_tipo_enum" NOT NULL, "descripcion" text, "imagen_url" character varying(500), "status" "public"."alfajores_status_enum" NOT NULL DEFAULT 'PENDING', "rejection_reason" text, "created_by_id" uuid, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "UQ_alfajor_nombre_marca" UNIQUE ("nombre", "marca_id"), CONSTRAINT "PK_5eaae3dfd65768e05fdcb2975eb" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_75c41d59b1fe6fd33821f998d7" ON "alfajores" ("marca_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_c327e4912d63fb3bc1f9a6b2fd" ON "alfajores" ("status") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_c1057fb9f8d6ddd0fee12365ab" ON "reviews" ("alfajor_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_0fe168752ce3bb4e7376d81f7a" ON "comments" ("review_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_4c675567d2a58f0b07cef09c13" ON "comments" ("user_id") `,
    );
    await queryRunner.query(
      `CREATE TABLE "comment_likes" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "comment_id" uuid NOT NULL, "user_id" uuid NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "UQ_comment_like_user" UNIQUE ("comment_id", "user_id"), CONSTRAINT "PK_2c299aaf1f903c45ee7e6c7b419" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_2073bf518ef7017ec19319a65e" ON "comment_likes" ("comment_id") `,
    );
    await queryRunner.query(
      `ALTER TABLE "alfajores" ADD CONSTRAINT "FK_75c41d59b1fe6fd33821f998d77" FOREIGN KEY ("marca_id") REFERENCES "marcas"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "alfajores" ADD CONSTRAINT "FK_1fca08aa146e4c7bc83157b4b5c" FOREIGN KEY ("created_by_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "reviews" ADD CONSTRAINT "FK_c1057fb9f8d6ddd0fee12365ab9" FOREIGN KEY ("alfajor_id") REFERENCES "alfajores"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "comments" ADD CONSTRAINT "FK_0fe168752ce3bb4e7376d81f7ad" FOREIGN KEY ("review_id") REFERENCES "reviews"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "comments" DROP CONSTRAINT "FK_0fe168752ce3bb4e7376d81f7ad"`,
    );
    await queryRunner.query(
      `ALTER TABLE "reviews" DROP CONSTRAINT "FK_c1057fb9f8d6ddd0fee12365ab9"`,
    );
    await queryRunner.query(
      `ALTER TABLE "reviews" DROP CONSTRAINT "FK_728447781a30bc3fcfe5c2f1cdf"`,
    );
    await queryRunner.query(
      `ALTER TABLE "alfajores" DROP CONSTRAINT "FK_1fca08aa146e4c7bc83157b4b5c"`,
    );
    await queryRunner.query(
      `ALTER TABLE "alfajores" DROP CONSTRAINT "FK_75c41d59b1fe6fd33821f998d77"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_2073bf518ef7017ec19319a65e"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_0fe168752ce3bb4e7376d81f7a"`,
    );
    await queryRunner.query(`DROP TABLE "comments"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_c1057fb9f8d6ddd0fee12365ab"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_c327e4912d63fb3bc1f9a6b2fd"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_75c41d59b1fe6fd33821f998d7"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_29f5713899c32a96a8900143c6"`,
    );
