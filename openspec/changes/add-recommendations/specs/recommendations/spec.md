...
Building a content-based taste fingerprint for the current user and returning the alfajores
they have not reviewed yet, ranked by a blend of taste fit (`matchPct`) and overall quality
(`score`), with a cold-start fallback for users without reviews.
